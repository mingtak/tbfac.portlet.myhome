...
#from tbfac.portlet.myhome import MyHomeMessageFactory as _


class IMyHome(IPortletDataProvider):
    """A portlet
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('myhome.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IMyHome)
